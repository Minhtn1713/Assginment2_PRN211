...
public partial class SalesManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__Member__0CF04B18927BC57D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BCFF832C1BE");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__OrderDet__08D097A309E0CEA8");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CDFC1D4E35");
